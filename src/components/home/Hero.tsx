const Hero = () => {
  ...
  return (
    <div className="h-[80dvh] sm:mt-10 md:mt-20 lg:mt-0 flex flex-col items-center justify-center gap-10 lg:flex-row lg:gap-0 px-10 xl:px-0 text-secondary-100 dark:text-gray-100/90">
