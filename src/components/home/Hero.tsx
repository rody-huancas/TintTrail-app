...
const Hero = () => {
  ...
  return (
    <div
      className="relative md:h-[80dvh] sm:mt-10 md:mt-20 lg:mt-0 flex flex-col items-center justify-center gap-10 lg:flex-row lg:gap-0 px-10 xl:px-0 text-secondary-100 dark:text-gray-100/90 mb-10 xl:mt-5"
    >
      <motion.div
      ...
      <motion.div
        className="lg:w-2/6 flex flex-col items-center lg:items-start gap-5 lg:gap-7"
        initial={{ opacity: 0, x: -50 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, delay: 0.2 }}
      >
        <h1 className="text-5xl font-extrabold uppercase text-center lg:text-start text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-purple-400">
          Crea tu propia paleta de colores
        </h1>
        <p className="text-lg text-gray-200 max-w-md text-center lg:text-start">
